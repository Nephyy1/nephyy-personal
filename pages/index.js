    ...
    <>
      <Head>
        ...
        <style>{`
          ...
          .animate-slide { animation: slide 10s linear infinite; }
        `}</style>
      </Head>
      <div className="bg-gradient-to-r from-blue-100 to-purple-100 text-gray-900">
        ...
        <section id="about" className="py-20 bg-white relative overflow-hidden">
          <img src="nyan-cat.gif" alt="Banner Transparan" className="absolute top-0 left-0 w-auto h-full object-contain opacity-50 animate-slide" />
