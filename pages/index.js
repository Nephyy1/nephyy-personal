...
          .qr-code-image:hover { transform: scale(1.05); }
          ...
          .animate-slide-in-left { animation: slide-in-left 1.5s cubic-bezier(0.25, 1, 0.5, 1) forwards; }
          .animate-slide-in-right { animation: slide-in-right 1.5s cubic-bezier(0.25, 1, 0.5, 1) forwards; }
        `}</style>
      </Head>
...
        </nav>
        
        <section id="home" className="min-h-screen flex items-center justify-center pt-20 relative z-20">
