      ...
      <div className="bg-gradient-to-r from-blue-100 to-purple-100 text-gray-900">
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex justify-between items-center py-4">
              ...
              <div className="hidden md:flex space-x-4">
                ...
                <a href="#certificate" className="hover:text-blue-500">Certificate</a>
            ...
            <div id="mobile-menu" className="md:hidden hidden">
              <div className="flex flex-col space-y-2 pb-4">
                ...
                <a href="#certificate" className="block hover:text-blue-500"><i className="uil uil-award mr-2"></i>Certificate</a>
        ...
        <section id="portfolio" className="py-20">
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md portfolio-card" data-aos="fade-up">
        ...
        <section id="certificate" className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md portfolio-card" data-aos="zoom-in">
                ...
                <p>Deskripsi singkat sertifikat 1.</p>
                <div className="mt-2">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md portfolio-card" data-aos="zoom-in">
                ...
                <p>Deskripsi singkat sertifikat 2.</p>
                <div className="mt-2">
                  <span className="inline-block bg-purple-200 text-purple-800 text-xs px-2 py-1 rounded-full"><i className="uil uil-award"></i> Official</span>
                </div>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md portfolio-card" data-aos="zoom-in">
                ...
                <p>Deskripsi singkat sertifikat 3.</p>
                <div className="mt-2">
                  <span className="inline-block bg-purple-200 text-purple-800 text-xs px-2 py-1 rounded-full"><i className="uil uil-award"></i> Official</span>
                </div>
              </div>
