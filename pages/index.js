...
export default function Home() {
  ...
  const handleUnlock = () => {
    window.Swal.fire({
      ...
      input: "password",
      inputLabel: "Masukkan password untuk membuka sertifikat",
      inputPlaceholder: "Password",
      showCancelButton: true
    }).then((result) => {
      if (result.value === "nephyy2025") {
        setCertUnlocked(true)
        window.Swal.fire("Berhasil!", "Sertifikat telah terbuka.", "success")
      } else {
        window.Swal.fire("Gagal!", "Password salah.", "error")
      }
    })
  }
  return (
      ...
      <div className="bg-gradient-to-r from-blue-100 to-purple-100 text-gray-900">
        ...
        <section id="certificate" className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            {!certUnlocked ? (
              <button onClick={handleUnlock} className="btn-interactive px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-full transition duration-300">
                Unlock Sertifikat
              </button>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
