...
export default function Home() {
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      const claimThr = document.getElementById("claim-thr")
      if (claimThr && window.Swal) {
        claimThr.addEventListener("click", function () {
          Swal.fire({
            title: "Klaim THR Lebaran!",
            text: "Klik tombol di bawah untuk klaim THR Anda.",
            width: 600,
            padding: "3em",
            color: "#716add",
            ...
            backdrop: `
    rgba(0,0,123,0.4)
    url("/nyan-cat.gif") left top / 200% auto no-repeat
  `,
            showCancelButton: true,
            confirmButtonText: "Klaim THR",
            cancelButtonText: "Tutup"
          }).then((result) => {
            if (result.isConfirmed) {
              window.location.href = "https://link.nephyy.tech/thr"
            }
          })
        })
      }
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-r from-blue-100 to-purple-100 text-gray-900">
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="flex justify-between items-center py-4">
              ...
              <div className="hidden md:flex space-x-4">
                ...
                <a id="claim-thr" className="hover:text-blue-500 transition-colors duration-300 cursor-pointer">Klaim THR</a>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md portfolio-card transition transform duration-300 hover:scale-105 hover:shadow-xl" data-aos="zoom-in">
                <img src="certificate1.jpg" alt="Sertifikat 1" className="w-full rounded-md mb-4" width="1754" height="1238" />
              ...
              <div className="bg-white p-6 rounded-lg shadow-md portfolio-card transition transform duration-300 hover:scale-105 hover:shadow-xl" data-aos="zoom-in">
                <img src="certificate2.jpg" alt="Sertifikat 2" className="w-full rounded-md mb-4" width="1754" height="1238" />
              ...
              <div className="bg-white p-6 rounded-lg shadow-md portfolio-card transition transform duration-300 hover:scale-105 hover:shadow-xl" data-aos="zoom-in">
                <img src="certificate3.jpg" alt="Sertifikat 3" className="w-full rounded-md mb-4" width="1754" height="1238" />
        ...
        <a href="https://trakteer.id/nephyy1/tip" target="_blank" className="fixed bottom-4 right-8 z-50">
