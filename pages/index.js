  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-r from-blue-100 to-purple-100 text-gray-900">
        ...
        <a href="https://link.nephyy.tech/thr" target="_blank" className="fixed bottom-24 right-8 z-50">
          <img src="kupat.png" alt="Popup" className="w-16 h-16 rounded-full shadow-lg transform transition active:scale-90 hover:scale-105" />
        </a>
