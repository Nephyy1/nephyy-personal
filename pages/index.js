    ...
    <>
      <Head>
        ...
        <style>{`
          ...
          @keyframes slide { 0% { transform: translateX(-100vw); } 100% { transform: translateX(0); } }
          .animate-slide { animation: fadeIn 0.5s ease-out, slide 5s linear infinite; }
        `}</style>
      </Head>
      <div className="bg-gradient-to-r from-blue-100 to-purple-100 text-gray-900">
        ...
        <section id="about" className="py-20 bg-white relative overflow-hidden">
          <img src="nyan-cat.gif" alt="Banner Transparan" style={{ top: "5px" }} className="absolute left-0 opacity-50 animate-slide" />
